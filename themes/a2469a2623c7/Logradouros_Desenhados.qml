...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" layerType="Vector" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="4.0.3-Norrköping">
  ...
  <temporal accumulate="0" durationField="id" durationUnit="min" enabled="0" endExpression="" endField="" fixedDuration="0" limitMode="0" mode="0" startExpression="" startField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation binding="Centroid" clamping="Terrain" customToleranceEnabled="1" extrusion="0" extrusionEnabled="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" symbology="Line" type="IndividualFeatures" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{feb54667-789d-44d7-bc91-d44b044698e7}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{11786fe6-8f96-4044-a6e1-7ddda7591c94}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{1d0d0a8b-a9a9-4ffb-87f1-266ede89f624}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="0" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{f1941628-b02d-4771-8b83-acbaa4cae03b}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
            ...
            <Option name="draw_inside_polygon" type="QString" value="0"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="line_color" type="QString" value="5,0,255,255,hsv:0.66991668939590454,1,1,1"/>
            <Option name="line_style" type="QString" value="solid"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{02066d1f-46b8-42e2-bb25-e3680ea8ba06}" locked="0" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="List">
        <Option type="QString" value="COALESCE( &quot;Logradouro&quot;, '&lt;NULL>' )"/>
        <Option type="QString" value="&quot;Logradouro&quot;"/>
        <Option type="invalid"/>
      </Option>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="Logradouro">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field configurationFlags="NoFlag" name="Hierarquia">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="Tip.Pavimento">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="CBUQ" type="QString" value="CBUQ"/>
              </Option>
              <Option type="Map">
                <Option name="Revestida com blocos pétreos" type="QString" value="Revestida com blocos pétreos"/>
              </Option>
              <Option type="Map">
                <Option name="Leito Natural" type="QString" value="Leito Natural"/>
              </Option>
              <Option type="Map">
                <Option name="Cascalho ou Brita Graduada" type="QString" value="Cascalho ou Brita Graduada"/>
              </Option>
              <Option type="Map">
                <Option name="Estrada de solo compacto com vegetação esparsa" type="QString" value="Estrada de solo compacto com vegetação esparsa"/>
              </Option>
              <Option type="Map">
                <Option name="Concreto" type="QString" value="Concreto"/>
              </Option>
              <Option type="Map">
                <Option name="Em Análise" type="QString" value="Em Análise"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="Logradouro" index="1" name=""/>
    <alias field="Hierarquia" index="2" name=""/>
    <alias field="Tip.Pavimento" index="3" name=""/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="id"/>
    <default applyOnUpdate="0" expression="" field="Logradouro"/>
    <default applyOnUpdate="0" expression="" field="Hierarquia"/>
    <default applyOnUpdate="0" expression="" field="Tip.Pavimento"/>
  </defaults>
  <constraints>
    <constraint constraints="3" exp_strength="0" field="id" notnull_strength="1" unique_strength="1"/>
    <constraint constraints="0" exp_strength="0" field="Logradouro" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Hierarquia" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Tip.Pavimento" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="Logradouro"/>
    <constraint desc="" exp="" field="Hierarquia"/>
    <constraint desc="" exp="" field="Tip.Pavimento"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;Tip.Pavimento&quot;" sortOrder="1">
    <columns>
      <column hidden="0" name="Logradouro" type="field" width="317"/>
      <column hidden="0" name="Hierarquia" type="field" width="-1"/>
      <column hidden="0" name="id" type="field" width="-1"/>
      <column hidden="0" name="Tip.Pavimento" type="field" width="-1"/>
...
def my_form_open(diálogo, camada, feição):
  ...
  <editable>
    <field editable="1" name="Hierarquia"/>
    <field editable="1" name="Logradouro"/>
    <field editable="1" name="Tip.Pavimento"/>
    <field editable="1" name="id"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="Hierarquia"/>
    <field labelOnTop="0" name="Logradouro"/>
    <field labelOnTop="0" name="Tip.Pavimento"/>
    <field labelOnTop="0" name="id"/>
  </labelOnTop>
  <reuseLastValuePolicy>
    <field name="Hierarquia" reuseLastValuePolicy="NotAllowed"/>
    <field name="Logradouro" reuseLastValuePolicy="NotAllowed"/>
    <field name="Tip.Pavimento" reuseLastValuePolicy="NotAllowed"/>
    <field name="id" reuseLastValuePolicy="NotAllowed"/>
  </reuseLastValuePolicy>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>COALESCE( "Logradouro", '&lt;NULL>' )</previewExpression>
